...
\[\frac{V_C-V_S}{R}=-C\frac{dV_C}{dt}\implies\frac{dV_C}{dt}=\frac{V_S-V_C}{RC}\implies\frac{dV_C}{V_S-V_C}=\frac{dt}{RC}\]

\[\implies\int_{V_C(0)}^{V_C(t)}\frac{dx}{V_S-x}=\int_0^t\frac{d\tau}{RC}\implies-\ln\left|V_S-x\right|\bigg|_{x=V_C(0)}^{x=V_C(t)}=\frac{125000}{33}\tau\bigg|_{\tau=0}^{\tau=t}\]

\[\implies\ln\left(\frac{V_S-V_C(t)}{V_S-V_C(0)}\right)=-\frac{125000t}{33}\implies V_C(t)=V_S+(V_C(0)-V_S)e^{-125000t/33}\]

The voltage across the resistor is then 

\[V_R=V_S-V_C\implies V_R=(V_S-V_C(0))e^{-125000t/33}\]
...
\[\left.\begin{array}{l}
V_C(t)=5-10e^{-125000t/33}\text{ V}\\
V_R(t)=10e^{-125000t/33}\text{ V}
...
\[\left.\begin{array}{l}
V_C(t)=-5+10e^{-125000(t-1.32\text{ ms})/33}\text{ V}\\
V_R(t)=-10e^{-125000(t-1.32\text{ ms})/33}\text{ V}
...
% V_C(t)
\addplot[blue, thick, domain=0:1.32, forget plot] {5-10*exp(-125*x/33)};
\addplot[blue, thick, domain=1.32:2.64, forget plot] {-5+10*exp(-125*(x-1.32)/33)};
\addplot[blue, thick, domain=2.64:3.96, forget plot] {5-10*exp(-125*(x-2.64)/33)};
\addplot[blue, thick, domain=3.96:5.28, forget plot] {-5+10*exp(-125*(x-3.96)/33)};

% V_R(t) 
\addplot[red, thick, dashed, domain=0:1.32, forget plot] {10*exp(-125*x/33)};
\addplot[red, thick, dashed, domain=1.32:2.64, forget plot] {-10*exp(-125*(x-1.32)/33)};
\addplot[red, thick, dashed, domain=2.64:3.96, forget plot] {10*exp(-125*(x-2.64)/33)};
\addplot[red, thick, dashed, domain=3.96:5.28, forget plot] {-10*exp(-125*(x-3.96)/33)};
