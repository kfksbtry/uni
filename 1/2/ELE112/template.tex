...
%%------------------------------------%%
{\textit{This part of the experiment is prepared with Online LaTeX Editor Overleaf, and the circuits are drawn in LTspice. Visit the website for the code here:}} %% Circuit drawing may not be required.
