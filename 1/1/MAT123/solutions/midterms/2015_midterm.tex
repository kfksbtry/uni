...
\[\text{I} = \int_{-2}^2 (8-x^2-2|x|)\,dx = \int_{-2}^0 (8-x^2+2x)\,dx + \int_{0}^2 (8-x^2 - 2x)\,dx\]

\[\text{I} = \left[8x-\frac{x^3}{3} + x^2 \right]_{-2}^0 + \left[8x-\frac{x^3}{3} - x^2 \right]_{0}^2\]

\[\text{I} = 0 - \left({-16} + \frac{8}{3} + 4\right) + \left(16 - \frac{8}{3} - 4\right) - 0 = \boxed{\frac{56}{3}}\]
