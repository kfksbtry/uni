...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \draw[dashed] (21,-1)--(21,-5); \draw[thick] (0,-8)--(21.5,-8); \draw[thick] (-2.5,-8)--(-5,-8); \draw[dashed] (0,-5)--(21,-5);
    \node at (19,-7) {$y=-8$};
    \node at (21,-0.5) {\small $21$};
    \node at (-0.75,-5) {\small $-5$};
  \end{axis}
\end{tikzpicture}
\end{center}
...
\noindent 7. The length of a curve defined by $x=f(y)$ whose derivative is continuous on the interval $a\leq x\leq b$ can be evaluated using the integral.
